                        ...
                        <div class="card-body">
                            <form action="{{ route('kampus.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="latitude" id="latitude" value="{{ old('latitude') }}" class="form-control col-md-8 @error('latitude') is-invalid @enderror">
                                    @error('latitude')
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="longitude" id="longitude" value="{{ old('longitude') }}" class="form-control col-md-8 @error('longitude') is-invalid @enderror">
                                    @error('longitude')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
