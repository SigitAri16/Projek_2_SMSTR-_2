            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Tambah Area Parkir</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body">
                            <form action="{{ route('area_parkir.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="number" name="kapasitas" id="kapasitas" value="{{ old('kapasitas') }}" class="form-control col-md-8" required>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <select name="kampus_id" id="kampus_id" class="form-control col-md-8" required>
                                        ...
                                        @foreach($kampuss as $kampus)
                                            <option value="{{ $kampus->id }}" {{ old('kampus_id') == $kampus->id ? 'selected' : '' }}>{{ $kampus->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
